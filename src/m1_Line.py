...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.cloneCount = 0
        self.start_original = start
        self.end_original = end
    ...
    def midpoint(self):
        ...
        p1 = Point((self.start.x + self.end.x) / 2, (self.start.y + self.end.y) / 2)
        return p1
    ...
    def is_parallel(self, line2):
        ...
        l2x = line2.end.x
        l2y = line2.end.y
        if p2x == p1x and l2x == l1x:
            return True
        if p2x == p1x or l2x == l1x:
            return False
        slope1 = (p2y - p1y) / (p2x - p1x)
        slope2 = (l2y - l1y) / (l2x - l1x)
